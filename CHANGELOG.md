...
**Full Changelog**: https://github.com/laravel/vite-plugin/compare/v3.1.2...v3.1.3
...
* Bump `fontaine` peer dependency by [@joetannenbaum](https://github.com/joetannenbaum) in https://github.com/laravel/vite-plugin/pull/354
* Pin GitHub Actions to commit SHAs and add Dependabot config by [@joetannenbaum](https://github.com/joetannenbaum) in https://github.com/laravel/vite-plugin/pull/355
* GitHub Actions hardening by [@nunomaduro](https://github.com/nunomaduro) in https://github.com/laravel/vite-plugin/pull/362
* Add Dependabot cooldown of 5 days by [@nunomaduro](https://github.com/nunomaduro) in https://github.com/laravel/vite-plugin/pull/363
* Bump github/codeql-action from 3.35.4 to 4.36.0 in the github-actions group across 1 directory by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/vite-plugin/pull/358
* Enable Dependabot auto-merge by [@nunomaduro](https://github.com/nunomaduro) in https://github.com/laravel/vite-plugin/pull/364
* Bump the github-actions group with 2 updates by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/vite-plugin/pull/367
* Bump esbuild from 0.27.4 to 0.28.1 by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/vite-plugin/pull/376
* [3.x] Sanitize variable font weight ranges in emitted asset filenames by [@naveentehrpariya](https://github.com/naveentehrpariya) in https://github.com/laravel/vite-plugin/pull/375
* [3.x] Respect the resolved Vite base in generated font CSS URLs by [@naveentehrpariya](https://github.com/naveentehrpariya) in https://github.com/laravel/vite-plugin/pull/372
* [3.x] Use spec-compliant format() keywords for ttf, otf, and eot fonts by [@naveentehrpariya](https://github.com/naveentehrpariya) in https://github.com/laravel/vite-plugin/pull/371
* [3.x] Honor the subsets option for google and bunny providers by [@naveentehrpariya](https://github.com/naveentehrpariya) in https://github.com/laravel/vite-plugin/pull/374
* [3.x] Warn when optimized font fallbacks cannot be generated by [@naveentehrpariya](https://github.com/naveentehrpariya) in https://github.com/laravel/vite-plugin/pull/373
* [3.x] Small fix in v3 upgrade guide by [@gdebrauwer](https://github.com/gdebrauwer) in https://github.com/laravel/vite-plugin/pull/346
* Bump actions/checkout from 6.0.3 to 7.0.0 in the github-actions group by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/vite-plugin/pull/381
* Bump the github-actions group with 3 updates by [@dependabot](https://github.com/dependabot)[bot] in https://github.com/laravel/vite-plugin/pull/382

### New Contributors

* [@nunomaduro](https://github.com/nunomaduro) made their first contribution in https://github.com/laravel/vite-plugin/pull/362
* [@naveentehrpariya](https://github.com/naveentehrpariya) made their first contribution in https://github.com/laravel/vite-plugin/pull/375
* [@gdebrauwer](https://github.com/gdebrauwer) made their first contribution in https://github.com/laravel/vite-plugin/pull/346

**Full Changelog**: https://github.com/laravel/vite-plugin/compare/v3.1.0...v3.1.1
